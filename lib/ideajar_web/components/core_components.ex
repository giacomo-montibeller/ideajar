defmodule IdeajarWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    #   Gettext.dngettext(IdeajarWeb.Gettext, "errors", msg, msg, count, opts)
    # else
    #   Gettext.dgettext(IdeajarWeb.Gettext, "errors", msg, opts)
    # end
